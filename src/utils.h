...
template<typename T> Nan::MaybeLocal<T> GetAttrMaybeLocal(v8::Local<v8::Object> object, const std::string &attribute) {
  return Nan::To<T>(GetAttr(object, attribute).ToLocalChecked());
}

template<typename T> Nan::Maybe<T> GetAttrMaybe(v8::Local<v8::Object> object, const std::string &attribute) {
  return Nan::To<T>(GetAttr(object, attribute).ToLocalChecked());
}

template<typename T> v8::Local<T> GetAttrLocal(v8::Local<v8::Object> object, const std::string &attribute) {
  return GetAttrMaybeLocal<T>(object, attribute).ToLocalChecked();
}
template<typename T> v8::Local<T> GetAttrLocal(Nan::MaybeLocal<v8::Object> object, const std::string &attribute) {
  return GetAttrLocal<T>(object.ToLocalChecked(), attribute);
}

template<typename T> T GetAttrJust(v8::Local<v8::Object> object, const std::string &attribute) {
  return GetAttrMaybe<T>(object, attribute).FromJust();
}
template<typename T> T GetAttrJust(Nan::MaybeLocal<v8::Object> object, const std::string &attribute) {
